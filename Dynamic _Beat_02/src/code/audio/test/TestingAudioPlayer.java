...
public class TestingAudioPlayer extends JFrame implements ActionListener {
		...
		playbackThread = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					JOptionPane.showMessageDialog(TestingAudioPlayer.this,  
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			@Override
			public void run() {
				new TestingAudioPlayer().setVisible(true);
			}
		});
	}
