...
public class Music extends Thread{
	...
	*/
	...
	private Music(){}
	private static Music itc = new Music();
	public static Music getInstance() 
	{ 
		System.out.println("생성자가 잘 실행이 되었습니다~ 쨔란 ★");
		File musicPath;
		try {
			if( /* condition1 */ ) { musicPath = new File(MainAction.class.getResource("../music/asterisk.wav").toURI());
			}else { 
	...
	public void PlayAndStopMusic(String location, boolean isLoop, int operation) {
		System.out.println("생성자가 잘 실행이 되었습니다~ 쨔란 ★");
		File musicPath;
		this.isLoop = isLoop;
		try {
